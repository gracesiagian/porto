...
switch ($action) {
    case 'create':
        ...
        // Check input file multiple (images[]) or fallback single image
        ...
        try {
            // 1. Insert primary portfolio item record
            ...
            // 3. Update primary cover image_url on portfolio_items with the first uploaded image
    ...
    case 'update':
        ...
        // Handle newly uploaded images (multiple or single)
        $files = $_FILES['images'] ?? null;
        $single_file_input = $_FILES['image'] ?? null;
        ...
        // Determine current max display order in portfolio_images for this item
        ...
        // If cover_image_url was empty and we uploaded new images, set cover to first new image
    ...
    case 'delete_image':
        ...
        if ($img_record) {
            // Delete physical file if in uploads/portfolio
            ...
            // If the deleted image was the primary image_url on portfolio_items, update with another image
    ...
    case 'delete':
        ...
        if ($item) {
            // 1. Delete all associated image files from disk
            ...
            // Also check cover image if different
            ...
            // 2. Delete portfolio item from DB (cascades to portfolio_images)
